//package site.sharetable.applelogin;
//
...
//
//        String idToken = String.valueOf(jsonNode.get("id_token"));
//        accessToken = String.valueOf(jsonNode.get("access_token"));
//
//        String subject = Jws.par
//
////        try {
...
////                    .parseClaimsJws(String.valueOf(jsonObj.get("id_token")))
////                    .getBody()
////                    .getSubject();
////
